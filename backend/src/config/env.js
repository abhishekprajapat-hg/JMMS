...
const env = {
  ...
  jwtSecret: process.env.JWT_SECRET || 'punyanidhi_dev_secret_change_me',
  jwtExpiresIn: process.env.JWT_EXPIRES_IN || '12h',
  devoteeJwtExpiresIn: process.env.DEVOTEE_JWT_EXPIRES_IN || '30d',
  jwtRefreshSecret: process.env.JWT_REFRESH_SECRET || `${process.env.JWT_SECRET || 'punyanidhi_dev_secret_change_me'}_refresh`,
  jwtRefreshExpiresIn: process.env.JWT_REFRESH_EXPIRES_IN || '30d',
  frontendOrigin: process.env.FRONTEND_ORIGIN || 'http://localhost:5173',
  frontendOrigins,
  timezone: process.env.APP_TIMEZONE || 'Asia/Kolkata',
  mongoUri: process.env.MONGO_URI || 'mongodb://127.0.0.1:27017/punyanidhi',
